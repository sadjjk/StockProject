...
logging_level=logging.WARNING # warning
...
FOOTER_STRING = [
    '你持有的最有潜力的一只股票是你自己!',
    '为什么手握上亿资金的庄家们总死盯着我这几万块钱不放？',
    '炒股和找对象一样，一开始都是自己精挑细选，到最后都变成了朋友介绍',
    '股市是一个很公平的地方，它既能让富人变穷，也能让穷人变得更穷',
    '我能想到最浪漫的事，就是和你一起慢慢解套',
    '侠之大者 为国接盘！',
    '你必须学会错杀、错失、错过，然后在遗憾中赚着属于自己的那一部分让人心安的小钱',
    '别和我讲技术,我玩股票都是一把梭哈！'
]